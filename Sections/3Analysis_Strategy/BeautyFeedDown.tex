...
$\Dzero$, about 4-7\% for the $\Dplus$ and about 5-8\% for the $\Dstar$, fully consistent with the value obtained for the p--Pb data sample, with rather similar cut selections.

\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{figures/fPrompts.JPG}
\caption{$f_{\rm prompt}$ as a function of the $\pt$ for $\Dzero$, $\Dstar$ and $\Dplus$ estimated on the basis of FONLL predictions}
\label{fprompt}
\end{figure}
