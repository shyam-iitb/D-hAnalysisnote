...
\begin{itemize}
  ...
  \item Minimum number of TPC crossed row of 90
...
The assigned uncertainty is 2.5 to 5\%, slightly increasing with the $\pt$ of the associated tracks (mainly due to the increase of the ITS-TPC matching efficiency).
