...
\begin{figure}
\centering
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins2to3_PoolInt_thr03to1_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins2to3_PoolInt_thr03to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins2to3_PoolInt_thr1to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins4to6_PoolInt_thr03to1_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins4to6_PoolInt_thr03to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins4to6_PoolInt_thr1to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins7to9_PoolInt_thr03to1_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins7to9_PoolInt_thr03to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins7to9_PoolInt_thr1to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins10to10_PoolInt_thr03to1_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins10to10_PoolInt_thr03to99_CUTVar.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/CutVar/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins10to10_PoolInt_thr1to99_CUTVar.png}}
...
In Fig. \ref{fig:SysTrEff020}, the ratio of correlation distributions with alternate/standard track selection is shown, for the three centrality ranges, in the various $\pt$ ranges, for the $\Dzero$ meson as trigger.
...
\begin{figure}
\centering
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins2to3_PoolInt_thr03to1_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins2to3_PoolInt_thr03to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins2to3_PoolInt_thr1to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins4to6_PoolInt_thr03to1_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins4to6_PoolInt_thr03to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins4to6_PoolInt_thr1to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins7to9_PoolInt_thr03to1_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins7to9_PoolInt_thr03to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins7to9_PoolInt_thr1to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins10to10_PoolInt_thr03to1_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins10to10_PoolInt_thr03to99_TrkEff.png}}
{\includegraphics[width=0.31\linewidth]{figures/Systematics/Dstar/TrkEff/Ratio_AzimCorrDistr_Dstar_Canvas_PtIntBins10to10_PoolInt_thr1to99_TrkEff.png}}\\
 \caption{Ratios of $\Dplus$-h correlation plots obtained with alternate associated track selection over those obtained with the standard cuts. Rows: $\pt$($\Dplus$) 3-5, 5-8, 8-16, 16-24 GeV/$c$. In each row, the panels show the associated track
$\pt$ ranges $> 0.3$, 0.3-1, $> 1$ GeV/$c$, respectively.}
...
\begin{comment} \\ change the path of plots for Dzero commented on 31 August2018 shyam
\begin{figure}
\centering
