...
The evaluation of the systematic uncertainties on the observables obtained from the fits is performed as follows (TO BE UPDATED):
...
%Marianna
%Pt>0.3
{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthaddot3to99dot.png}}
%Pt>1.0
{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthad1dotto99dot.png}}
%Pt>2.0
%{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthad2dotto99dot.png}}
%Pt>3.0
%{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthad3dotto99dot.png}}
%Pt>0.3-1.0
{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthaddot3to1dot.png}}
%Pt>1.0-2.0
{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthad1dotto2dot.png}}
%Pt>2.0-3.0
{\includegraphics[width=0.49\linewidth, height=0.33\linewidth]{figures/Fits/CanvasFinalTrendNSYield_pthad2dotto3dot.png}}
\end{figure}
\begin{figure}[!htbp]
\centering
%Pt>0.3
...
\begin{figure}
\centering
\includegraphics[width=.95\linewidth]{figures/ComparisonTopPb/CompareFitResults_ppVspPb_5TeV_1.png}
...
\begin{figure}
\centering
\includegraphics[width=.95\linewidth]{figures/ComparisonTopPb/CompareFitResults_ppVspPb_5TeV_AwaySide_1.png}
...
\centering
%Marianna
\includegraphics[width=.45\linewidth]{figures/ComparisonTopPb/plotComparison_WeightedAverage_pp_vsEnergies_UniqueCanvas_Style1.png}
%\includegraphics[width=.45\linewidth]{figures/ComparisonTopPb/plotComparison_WeightedAverage_pp_pPb_UniqueCanvas_Style1_1.png} \\
...
\begin{figure}
\centering
\includegraphics[width=.95\linewidth]{figures/ComparisonTopPb/CompareFitResults_DiffppEnergies.png}
%\includegraphics[width=.95\linewidth]{figures/ComparisonTopPb/CompareFitResults_ppVspPb_5TeV_2.png}
\caption{Near-side yield and sigmas for the average of $\Dzero$, $\Dplus$ and $\Dstar$ azimuthal correlations in pp at 5 (blue), 7 (red) and 13 (green) TeV in all the common kinematic regions of trigger and associated track.}
\label{fig:AllppFit1}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.95\linewidth]{figures/ComparisonTopPb/CompareFitResults_DiffppEnergies_AwaySide.png}
%\includegraphics[width=.95\linewidth]{figures/ComparisonTopPb/CompareFitResults_ppVspPb_5TeV_AwaySide_2.png}
\caption{Away-side yield and sigmas for the average of $\Dzero$, $\Dplus$ and $\Dstar$ azimuthal correlations in pp at 5 (blue), 7 (red) and 13 (green) TeV in all the common kinematic regions of trigger and associated track.}
\label{fig:AllppFit2}
\end{figure}
...
\centering
%Marianna
\includegraphics[width=.95\linewidth]{figures/ComparisonToModels/CorrelationppMC4x6_1New.png}
\includegraphics[width=.95\linewidth]{figures/ComparisonToModels/CorrelationppMC4x6_2New.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.95\linewidth]{figures/ComparisonToModels/ComparePPtoMCFitResults.png}
\includegraphics[width=.95\linewidth]{figures/ComparisonToModels/ComparePPtoMCFitResults_2.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.95\linewidth]{figures/ComparisonToModels/ComparePPtoMCFitResultsAS.png}
\includegraphics[width=.95\linewidth]{figures/ComparisonToModels/ComparePPtoMCFitResultsAS_2.png}
\caption{Near-side fit parameters obtained for D-meson averages, extracted from data and simulations different event generators (PHYTIA, with three tunes, and POWHEG$+$PYTHIA), in the different kinematic ranges analyzed.}.
\label{pp-models}
\end{figure}
