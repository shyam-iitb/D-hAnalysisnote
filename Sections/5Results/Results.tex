...
\caption{D-meson $\pt$ trend of near-side yield, for the various associated track $\pt$ ranges, with statistical and systematic unceratinties. Note: do not consider the first bin of each panel (excluded from the results).}
\label{fig:NSyield}
\end{figure}
\begin{figure}[!htbp]
\centering
